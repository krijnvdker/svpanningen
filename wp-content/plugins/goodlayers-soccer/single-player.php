	...
	<div class="gdlr-soccer-player-tab-title-wrapper">
		<div class="gdlr-soccer-player-tab-title-container container">
			<div class="gdlr-soccer-player-tab-title-inner gdlr-item gdlr-title-font">
				<?php if( empty($player_options['player-stats']['enable-player-stats']) || $player_options['player-stats']['enable-player-stats'] == 'enable' ){ ?>
					<a class="gdlr-soccer-tab <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" href="#" data-tab="player-stats" ><?php _e('Player Stats', 'gdlr-soccer'); ?></a> 
					<span class="gdlr-separator" >|</span>
				<?php } ?>
				<a class="gdlr-soccer-tab <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" href="#" data-tab="biography" ><?php _e('Biography', 'gdlr-soccer'); ?></a> 
				<span class="gdlr-separator" >|</span> 
				<a class="gdlr-soccer-tab <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" href="#" data-tab="gallery" ><?php _e('Gallery', 'gdlr-soccer'); ?></a> 
			</div>
			...
			<div class="with-sidebar-left <?php echo $gdlr_sidebar['outer']; ?> columns">
				<div class="with-sidebar-content <?php echo $gdlr_sidebar['center']; ?> columns">
					<div class="gdlr-soccer-single-player gdlr-item gdlr-item-start-content" >
						...
						<!-- player stats -->
						<?php if( empty($player_options['player-stats']['enable-player-stats']) || $player_options['player-stats']['enable-player-stats'] == 'enable' ){ ?>
						<div class="gdlr-soccer-tab-content <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" data-tab="player-stats">
						...
						<!-- biography -->
						<div class="gdlr-soccer-tab-content <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" data-tab="biography">
							<?php
						...
						<!-- gallery -->
						<div class="gdlr-soccer-tab-content <?php echo esc_attr($tab_active_class); $tab_active_class = ''; ?>" data-tab="gallery">
							<?php
								if( function_exists('gdlr_content_filter') ){
