            ...
            <ul class="nav nav-tabs">
              ...
              $is_isset_tab = false;
                ...
                <li <?php echo (($intA == 0 && !$jscurtab) || ($jscurtab == '#'.$tabs[$intA]['id'])) ? 'class="active"' : '';
                    ...
                    ?>"><i class="<?php echo $tab_ico;?>" <?php if($tab_icoImg){echo ' style="background:url('.wp_get_attachment_image_url($tab_icoImg,array(24,24),false).'")';}?>></i> <span><?php echo $tabs[$intA]['title'];
                    ?></span></a></li>
              <?php 
                }
                ?>
