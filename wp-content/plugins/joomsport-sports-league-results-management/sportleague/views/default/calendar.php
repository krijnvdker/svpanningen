...
<form role="form" method="post" lpformnum="1">
    ...
    ?></label>
                              ...
                              <input type="text" class="jsdatefield" name="filtersvar[date_from]" value="<?php echo  (isset($lists['filtersvar']->date_from) && $lists['filtersvar']->date_from) ? htmlspecialchars($lists['filtersvar']->date_from,ENT_QUOTES) : ''?>" class="form-control " id="date_from" placeholder="">
                                <input type="text" class="jsdatefield" name="filtersvar[date_to]" value="<?php echo  (isset($lists['filtersvar']->date_to) && $lists['filtersvar']->date_to) ? htmlspecialchars($lists['filtersvar']->date_to,ENT_QUOTES) : ''?>" class="form-control" id="date_to" placeholder="">
