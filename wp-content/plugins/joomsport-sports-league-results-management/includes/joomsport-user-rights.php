...
class JoomSportUserRights {
    ...
    public static function canAddTeam(){
        ...
        if(!current_user_can('manage_options')){
            ...
            if(JoomsportSettings::get('player_per_account',0) && JoomsportSettings::get('player_per_account',0) <= $your_teams){
                return false;
            }
        }
        return true;
    ...
    public static function canAddPlayer(){
        ...
        if(!current_user_can('manage_options')){
            ...
            if(JoomsportSettings::get('teams_per_account',0) && JoomsportSettings::get('teams_per_account',0) <= $your_players){
                return false;
            }
        }
        return true;
