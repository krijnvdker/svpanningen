    ...
    <div>
      ...
      <div>
          <label><?php echo __("Display team", "joomsport-sports-league-results-management");?></label>
                ...
                ?>
                <?php echo JoomSportHelperSelectBox::Simple($this->get_field_name( 'displayname' ), $lists,$displayname, ' id="displayTeamName"', false);?>
      </div>    
      ...
      <div>
        ...
        <div>
            <label><?php echo __("Display player", "joomsport-sports-league-results-management");?></label>
                ...
                ?>
                <?php echo JoomSportHelperSelectBox::Simple($this->get_field_name( 'displayplayername' ), $lists,$displayplayername, ' id="displayPlayerName"', false);?>
        </div>
