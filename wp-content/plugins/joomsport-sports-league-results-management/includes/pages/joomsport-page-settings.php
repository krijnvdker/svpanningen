    ...
    public static function action(){
        ...
        if (isset($_REQUEST['nonce']) && wp_verify_nonce($_REQUEST['nonce'], basename(__FILE__))) {
            ...
            */
            ...
            if(isset($layouts['opposite_events']) && $layouts['opposite_events']){
                $layouts['opposite_events'] = json_encode($layouts['opposite_events']);
            }
                            ...
                            <table class="adminlistsNoBorder">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if(count($eventsOnly)){
                                            echo '<select name="layouts[opposite_events][]"  class="jswf-chosen-select" data-placeholder="'.__('Add item','joomsport-sports-league-results-management').'" multiple>';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo JoomSportHelperSelectBox::Radio('layouts[enbl_mdnameonmatch]', $is_field_yn,JoomsportSettings::get('enbl_mdnameonmatch',1),'');
                                        ?>
                                ...
                                <table class="adminlistsNoBorder">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                echo JoomSportHelperSelectBox::Simple('layouts[players_display_name]', $listsPl,JoomsportSettings::get('players_display_name',0), '', false);?>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <?php 
                                                echo JoomSportHelperSelectBox::Radio('layouts[enbl_player_system_num]', $is_field_yn,JoomsportSettings::get('enbl_player_system_num',0),'');
                                                ?>
                            ...
                            <div class="jsBEsettings">
                                <table class="adminlistsNoBorder">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            echo JoomSportHelperSelectBox::Simple('layouts[shortenteam]', $is_data_shortened,JoomsportSettings::get('shortenteam','-1'),'',true);
