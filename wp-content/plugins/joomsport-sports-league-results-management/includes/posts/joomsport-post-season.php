...
class JoomSportPostSeason {
    ...
    public static function joomsport_standings_shortcode(){
        ...
        <div class="JSshrtPop">
            ...
            <div>
                <?php echo self::displayTeamNameOption();?>
    ...
    public static function joomsport_plstat_shortcode(){
        ...
        <div class="JSshrtPop">
            ...
            <div>
                <?php echo self::displayPlayerNameOption();?>
            </div>
            <div>
    ...
    public static function joomsport_playerlist_shortcode(){
        ...
        <div class="JSshrtPop JSshrtPopPlayerList">
            ...
            echo '<input type="hidden" value="'.JoomSportHelperObjects::getCurrentTournamentType().'" id="tourntype" />';
    ...
    public static function displayTeamNameOption($value = 1){
        ?>
                ...
                ?>
                <?php echo JoomSportHelperSelectBox::Simple('displayName', $lists,$value, ' id="displayTeamName"', false);?>
        <?php
    }
     ...
     public static function displayPlayerNameOption($value = 1){
        ?>
                ...
                ?>
                <?php echo JoomSportHelperSelectBox::Simple('displayPlayerName', $lists,$value, ' id="displayPlayerName"', false);?>
        <?php
    }
