...
Check [Statorium football API service](https://statorium.com/?utm_source=wpcatalogue&utm_medium=web&utm_campaign=passiveweb "Statroium soccer data API") connected (pro edition)
...
* European Football, Soccer (e.g. Champions league, FIFA World Cup Qatar, UEFA EURO 2020, English Premier League, Bundesliga, La Liga)
...
* Integration with updates system from [Statorium Data API service] (https://statorium.com "Statorium soccer live scores API"). Pro version.
* Import ability of the new default fields from [Statorium Data API service] (https://statorium.com "Statorium soccer live scores API"). Pro version.
